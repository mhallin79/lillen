...
working and open windows and roof hatches to ensure there is adequate ventilation.
</div>
...
<div class="alert alert-info">
    ...
    <strong>Info:</strong> If gas is not required overnight, it's recommeded to turn the gas of by the bottles before going to bed.
</div>
...
<div class="alert alert-success">
    ...
    <strong>Tip:</strong> Before turning of the gas by the bottle, ignite one cooktop burner, then turn the valve off and let the flame on burner, burn out by itself. 
