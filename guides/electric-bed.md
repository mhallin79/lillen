...
The bed is operated from the control switch that is located under the TV unit. 
![lift control](images/electric-bed-lift-control.jpg)

Before lowering the bed, remove all cushions and lower the table to it's lowest setting.
![lift control](images/electric-bed-preparation.jpg)
...
<div class="alert alert-danger">
    <svg class="svg-inline--fa fa-triangle-exclamation fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="triangle-exclamation" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M506.3 417l-213.3-364c-16.33-28-57.54-28-73.98 0l-213.2 364C-10.59 444.9 9.849 480 42.74 480h426.6C502.1 480 522.6 445 506.3 417zM232 168c0-13.25 10.75-24 24-24S280 154.8 280 168v128c0 13.25-10.75 24-23.1 24S232 309.3 232 296V168zM256 416c-17.36 0-31.44-14.08-31.44-31.44c0-17.36 14.07-31.44 31.44-31.44s31.44 14.08 31.44 31.44C287.4 401.9 273.4 416 256 416z"/></svg>  
    <strong>Important:</strong> Inspect the vertical trolley channels and chain for dirt or debris and clean as necessary.
</div>
...
voltage to lift the bed back up. 
...
5. Start the car engine and check the voltage again by pressing button 3 again. The battery level should now be showing green. 
6. Raise the bed
...
<div class="alert alert-success">
    ...
    <strong>Tip:</strong> Ensure that the rooftop solar panels are not covered by shade for optimal charging of the 12V batteries.
</div>
...
![cover](images/electric-bed-storage-box-cover.jpg)

Ensure that all cables are properly secured.
![cover](images/electric-bed-storage-box.jpg)
