...
<label for="water-pump"><input type="checkbox" id="water-pump"/> Turn the water pump on (button 4 on the [Battery and Water Control Panel](../guides/control-panel.md)), if not connected to city water.</label>
